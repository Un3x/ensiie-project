<?php
	...
	function newStory($first_node){
		$link = dbConnect();
		$pseudo = $_SESSION['name'];
		$date = date("Y-m-d");
		$createStory = "INSERT INTO `current_story`(`pseudo`, `step`, `date_current`, `ghost`, `alcohol`, `attendance`, `bar`, `baka`, `diese`, `is_bar`, `is_baka`, `is_diese`) VALUES ('$pseudo', '$first_node', '$date', 50, 50, 50, 50, 50, 50, 0, 0, 0)";	
