			...
			<div id = \"content\" class = \"round_rect\"> 
				...
				<div id = \"main_header\">
					<p>
						...
						<span class = \"orange\"><span style = \"font-family:Just Another Hand\">ta 1A a l<span style = \"font-family:sans-serif\">'</span>ENSIIE </span> <span style = \"font-family:Just Another Hand\"><span style = \"font-family:sans-serif\">!</span></span>
					</p>
				</div>
	...
	function printStoryChoice(){
		echo "	<h1 class = \"brown\">Nouvelle histoire</h1>
				...
				<div id = \"new_stories\">
					...
					<div class = \"story\">
						<div class = \"content\">
							<h1 class = \"brown\">Histoire personnalisée</h1>
							<div class = \"desc\"><p class = \"grey\">Une fois votre histoire personnalisée insérée dans la base de données, vous pourrez la lancer ici. Cliquer sur Jouer amène au noeud 50, une fin temporaire.</p>
							<button class = \"logout_button\" onclick =\"initNewStory(50)\">Jouer</button>
							</div>
