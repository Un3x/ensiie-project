...
<?php if($_GET['disponibilite']=='oui'){?>
        ...
        $titre=$_GET['titre'];
         $reser= $bdd->query("INSERT INTO Emprunts Values($pseudo,$id,'22/03/2020')");
          echo("L'audio $titre avec comme reference $id a été résérvé avec succés ");
    ...
    $id=$_GET['reference'];
    $titre=$_GET['titre'];
    echo("L'audio $titre a été réservé avec succés et un administrateur va vous contacter très prochainement pour la remise.");
