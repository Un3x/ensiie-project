<?php
session_start();
$_SESSION['adresse']="nathane/4.php";
...
?>
                       ...
                       <body>
                       <h1 id="citations">Read vine</h1>
                       <section class="center">
                       <p>Pour expliquer cette merveilleuse citation:<br/>
                 <strong>L'allignement des vignes fais fortement penser à des lignes d'un livre.
                 </strong><br/>
                 <img src='vignes.jpeg' >
                 <h3 id="citation1">Lire entre les vignes</h3>
           </section>
           </body>
           </html>
