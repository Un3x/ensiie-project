<?php
session_start();
$_SESSION['adresse']="nathane/3.php";
...
?>
                 ...
                 <body>
                 <h1 id="citations">Chic and rain</h1>
                 <section class="center">
                 <p>Pour expliquer cette merveilleuse citation:<br/>
           <strong>Marilyn Monroe fusionne avec Mary Poppins.
           </strong>.<br/>
           <img src='marilyn.jpeg' >
           <img src='poppins.jpeg' >
           <h3 id="citation1">Marilyn Poppins</h3>
     </section>
     </body>
     </html>