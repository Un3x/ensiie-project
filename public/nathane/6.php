<?php
session_start();
$_SESSION['adresse']="nathane/6.php";
...
?>
                       ...
                       <body>
                       <h1 id="citations">Room and chance</h1>
                       <section class="center">
                       <p>Pour expliquer cette merveilleuse citation:<br/>
                 <strong>Avec un peu de chance lorsque l'on découvre une nouvelle maison on aura une belle chambre
                 </strong>.<br/>
                 <img src='chambre.jpeg' >
                 <h3 id="citation1">Au petit bonheur la chambre</h3>
           </section>
           </body>
           </html>
