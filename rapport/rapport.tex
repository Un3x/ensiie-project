...
\subsubsubsection{vérification des données}
\\
...
\subsubsubsection{Choix de la race pour le transporteur} 
...
En s'aidant des variables de sessions et de celles défini dans config.php, il est facilement possible dans php d'y inclure un menu supplémentaire pour accéder à ses pages, selon le degré de connexion et le type de connexion . 
