...
Lors d'un jeu, voici la manière dont les points sont décomptés :
    ...
    <li>zéro (« love » en anglais) : pour aucun point marqué dans le jeu ;</li>
    <li>quinze : pour un point marqué ;</li>
    <li>trente : pour deux points marqués ;</li>
    <li>quarante : pour trois points marqués.</li>
    <br/>

Lorsque les deux joueurs ont marqué trois points, (donc à 40/40), il y a égalité. Celui qui marque le point suivant obtient un « avantage ». Pour remporter le jeu, un joueur qui a l'avantage doit marquer un autre point. Si c'est le joueur qui n'a pas l'avantage qui marque le point suivant, on revient à égalité, et ainsi de suite jusqu'à ce que l'un des deux joueurs remporte le jeu. Chez les jeunes enfants âgés au plus de 11 ans, la règle de l'avantage n'existe pas. C'est la règle du « No-ad » (« No advantage ») qui s'exerce. Le joueur qui reçoit choisit sa zone de retour de service pour le point décisif (toujours à 40-40). Cette variante est aussi parfois appliquée en double13.
</p>
<p>
Concernant l'arbitrage, on donne toujours le score du serveur en premier. Par exemple, si le serveur marque trois points contre deux à son adversaire, le score est 40/30. Dans le cas contraire, le score est 30/40. Il en est de même au niveau des « avantages », lorsqu'il y a égalité dans un jeu. Lorsque c'est le serveur qui a l'avantage, l'arbitre annoncera « avantage » puis le nom du joueur ou de la joueuse. En double, l'arbitre annoncera le nom du serveur ou du relanceur. Toutefois, en cas de Championnat par équipe ou d'équipes nationales (Coupe Davis ou Fed Cup, par exemple), le nom du club ou du pays est alors donné.</p>
<h2>Challenges</h2>
<p>Depuis 2006, les joueurs et joueuses peuvent avoir recours à un système d'images de synthèse retraçant la trajectoire et surtout le point d'impact de la balle, appelé « Hawk-Eye » (« œil de faucon ») afin de contester une décision arbitrale qu'ils jugent erronée. Plusieurs règles s'appliquent à l'usage de ce moyen : 
    <li>Le challenge doit être demandé immédiatement après le coup présumé juste par l'arbitrage, mais vu faute par le joueur, ou vu faute par l'arbitrage mais considéré juste par le joueur.</li>
    <li>Le joueur dispose de trois challenges au début de chaque set (manche), plus un si le jeu va jusqu'au Tie break. Si son appréciation d'un point ou d'une faute est erronée, il perd à chaque fois l'un de ses challenges.</li>
    <li>Si le corps arbitral annonce une balle faute alors qu'elle était bonne, le coup doit être rejoué, pour autant que l'adversaire ait été jugé en mesure de renvoyer la balle. Par exemple, si le joueur A frappe une balle qui est signalée faute par erreur, on tient compte alors de la position du joueur B par rapport à la balle au moment de l'impact. Si le joueur B était manifestement trop loin pour renvoyer la balle, le point est accordé au joueur A. Dans le cas contraire, le point est rejoué (le serveur sert alors avec une première balle, même si le point avait été engagé par une seconde balle).</li>
    <li>Si, lors d'un échange, l'un des joueurs voit une balle faute non-signalée, il peut interrompre l'échange et demander le challenge. Si la balle est faute, le point lui est accordé, si la balle est bonne, le point est accordé à l'adversaire.</li>
    <li>Si, pour une raison indéterminée, le système Hawk Eye devait ne pas fonctionner, la décision arbitrale prévaudrait.</li>
