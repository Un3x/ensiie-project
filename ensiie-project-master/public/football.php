...
Un match commencé peut être définitivement arrêté à la discrétion de l'arbitre, en cas de circonstance particulière (intempéries, bagarres), ou après 45 minutes d'interruption ou bien lorsqu’une équipe ne dispose plus d'assez de joueurs (par expulsion ou blessures), moins de huit pour les matchs internationaux par exemple.</p>
<h2>Coup d'envoi et reprise du jeu et ballon en jeu et hors du jeu</h2>
<p>Avant match, le choix des camps est déterminé par un tirage au sort, traditionnellement effectué au moyen d’une pièce de monnaie. L’équipe favorisée par le sort choisit le but contre lequel elle attaquera durant la première mi-temps, l'autre équipe donnant le coup d'envoi. En seconde période, les équipes changent de camp.
...
Le ballon reste en jeu tant qu'il n'a pas entièrement franchi la ligne de but ou la ligne de touche, que ce soit à terre ou en l’air, ou que le jeu n'a pas été arrêté par l’arbitre.</p>
<h2>Déterminer le résultat d'un match</h2>
<p>Un but est marqué quand le ballon a entièrement franchi la ligne de but, entre les montants du but et sous la barre transversale, sous réserve qu’aucune infraction aux lois du jeu n’ait été préalablement commise par l’équipe en faveur de laquelle un but aura été marqué, et quel que soit le dernier joueur à avoir touché le ballon. Un but peut être marqué directement après un coup de pied arrêté (coup d'envoi, « six mètres », penalty, coup franc direct, corner), à l'exception des coups francs indirects.

L’équipe qui aura marqué le plus grand nombre de buts pendant le match remporte la victoire. Quand les deux équipes marquent le même nombre de buts ou ne marquent aucun but, le match est déclaré nul, et peut être suivi de prolongations et de tirs aux buts.</p>
<h2>Hors-jeu</h2>
<p>Un joueur se trouve en position de hors-jeu quand il est dans la moitié de terrain adverse et plus près de la ligne de but adverse que le ballon et l’avant-dernier adversaire (le dernier adversaire étant généralement le gardien de but), les bras et les mains ne comptant pas. Un joueur qui prend une part active au jeu alors qu'il était en position de hors-jeu au moment où le ballon a été touché par un de ses partenaires est sanctionné d'un coup franc indirect.</p>
<h2>Fautes et incorrections</h2>
<p>Les fautes et incorrections sont sanctionnées de façon à lutter contre l'antijeu : il s'agit de manière générale de toutes les brutalités ou actes d'antijeu exercés contre un adversaire, par exemple le fait de toucher délibérément le ballon avec les bras (à l'exception du gardien de but dans sa surface de réparation). Elles donnent lieu à un coup franc, à exécuter à l’endroit où la faute a été commise.

Le joueur sanctionné peut recevoir un carton jaune ou un carton rouge, synonymes d'avertissement ou d'exclusion du terrain. Selon les règlements de chaque compétition, les joueurs avertis ou exclus sont passibles de suspensions pour les matchs suivants.</p>
<h2>Coups francs, penalty, rentrée de touche, coup de pied de but et corner</h2>
<p>Les coups francs sont accordés pour sanctionner les fautes et comportements antisportifs définis par la loi 12. Ils peuvent être directs (fautes avec contact physique ou manque de respect envers d'autres joueurs) ou indirects (fautes sans contact physique, notamment celles des gardiens), selon qu'ils peuvent donner lieu, ou pas, à un but sur une frappe directe. Pour le coup franc direct comme pour le coup franc indirect, le ballon doit être immobile au moment de la frappe, et l’exécutant ne doit pas toucher le ballon une seconde fois avant que celui-ci n’ait été touché par un autre joueur (de la même équipe ou non).</p>
<p>Si l’équipe qui commet l’une des dix fautes pour lesquelles un coup franc direct doit être accordé le fait dans sa propre surface de réparation, elle est pénalisée d'un coup de pied de réparation, ou « penalty » (de l'anglais : penalty kick), décrit dans la loi 14. Le coup franc est alors tiré du point du coup de pied de réparation. Le gardien de but de l’équipe défendant reste sur sa propre ligne de but, face à l’exécutant. Tous les joueurs autres que l’exécutant doivent se trouver en dehors de la surface de réparation. Dans le cas du coup franc indirect, celui- ci reste joué à l'interieur de la surface à l'endroit de la faute.
...
Enfin, quand le ballon a entièrement franchi une ligne de but sans qu’un but ait été marqué, il peut être remis en jeu de deux manières, selon l'équipe du dernier joueur à avoir touché le ballon.
    ...
    <li>S'il s'agit de l’équipe attaquante, un « coup de pied de but », communément appelé « dégagement en six mètres », est sifflé : le ballon est alors botté d'un point quelconque de la surface de but par un des joueurs de l'équipe défendante.</li>
    <li>S'il s'agit de l'équipe défendante, un « coup de pied de coin », communément appelé « corner » (de l'anglais corner kick) est accordé à l'équipe attaquante. Le ballon placé dans l’arc de cercle du coin du terrain le plus proche d'où il est sorti, est botté par un joueur de l’équipe attaquante.</li></p>

<a href="sports.php">Retour aux sports</a></div>    
</figure>
