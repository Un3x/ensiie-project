...
Que ce soit en attaque ou en défense, chaque joueur joue à un poste précis, désigné par un numéro. Il existe de nombreuses variantes et possibilités, selon la stratégie adoptée par l'entraîneur, mais le schéma de base fonctionne avec cinq postes « classiques » :
    <li>Le meneur (point guard) est chargé de distribuer la balle et d'organiser le jeu en attaque. Il monte la balle depuis son propre camp et annonce les tactiques à mettre en place84. En plus de bonnes capacités au dribble, il doit avoir une excellente vision du jeu pour pouvoir distribuer le ballon à ses coéquipiers. Les meneurs sont généralement les joueurs les plus petits de l'équipe, ce qui leur permet de pénétrer rapidement dans la raquette pour effectuer des lay-ups et de réaliser des interceptions.</li>
    <li>L’arrière (shooting guard) est un joueur endurant, rapide, agile et doté de bonnes capacités athlétiques85. Son rôle principal est de marquer des paniers à trois points : il doit donc avoir une bonne capacité au tir85. Il effectue également quelques pénétrations dans la raquette pour des lay-ups ou des dunks, et effectue un marquage serré des attaquants adverses.</li>
    <li>L'ailier (small forward), également appelé ailier shooteur ou petit ailier, est un joueur polyvalent capable aussi bien de tirer à trois points que de jouer dans la raquette, en aidant par exemple les intérieurs au rebond. Son jeu est généralement un compromis entre l'agilité et la rapidité d'un meneur, et la taille et la puissance d'un pivot86. Le poste mêle ainsi une dimension offensive et une dimension défensive. La plupart des ailiers professionnels mesure environ deux mètres.</li>
    <li>L'ailier fort (power forward) joue un rôle similaire à celui du pivot et forme avec lui le secteur dit « intérieur ». Son rôle est principalement défensif : il doit empêcher les attaquants adverses d'approcher du panier, capter des rebonds défensifs et contrer les tirs des adversaires. Plus petit que le pivot, il peut évoluer plus loin du panier87. Il peut également réaliser des tirs intérieurs en attaque.</li>
    <li>Le pivot (center) est généralement le joueur le plus grand (souvent autour de deux mètres dix) et le plus fort physiquement88. Il est ainsi fréquemment surnommé big man. Son rôle est de protéger la raquette en utilisant sa taille et sa corpulence, pour empêcher les adversaires de tirer ou de dunker en les contrant. Leur taille leur permet également de capter de nombreux rebonds et de dunker facilement. Ce sont toutefois des joueurs lents88 et parfois malhabiles, ayant souvent des difficultés au tir intérieur et aux lancers francs. Les pivots étaient les joueurs-clés de l'équipe jusqu'aux années 1990 et les plus convoités lors des drafts.</li>
