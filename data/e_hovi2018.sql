...
-- Généré le :  Lun 13 Mai 2019 à 23:17
...
--
-- Contenu de la table `completed`
--

INSERT INTO `completed` (`pseudo`, `end_id`, `ghost`, `alcohol`, `attendance`, `bar`, `baka`, `diese`, `is_bar`, `is_baka`, `is_diese`, `date_end`) VALUES
('Kat', 1, 50, 50, 50, 50, 50, 50, 0, 0, 0, '2019-05-11');
...
--
-- Contenu de la table `ends`
--

INSERT INTO `ends` (`end_id`, `end_node`, `title`, `full_text`, `short_text`) VALUES
(1, 3, 'Opportunité ratée', 'Tu n\'as pas rejoins le bar. Ta culpabilité est telle que tu sombres peu à peu dans l\'alcoolisme que tu cherchais à éviter, et tu passes désormais tes journées à te morfondre dans ta petite chambre de 9m², vide et froide.', 'n\'a pas rejoint Le Bar (c) et est tombé en dépression');
...
(1, 0, 0, 20, -30, 0, 20, -1, 0, 0, NULL, 'Veux-tu rejoindre Le Bar (c) ?', 'facade.png', 'chara-test.png'),
(2, 0, 0, -20, 30, 0, -20, 1, 0, 0, 1, 'Bienvenue !', 'bar_encours.png', NULL),
(3, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 'Rejoindre le bar ? Et puis quoi encore ??! Tu tournes immédiatement les talons et t\'éloignes au plus vite de ce lieu de débauche. ', 'bar_encours.png', NULL);
...
--
ALTER TABLE `completed`
  MODIFY `end_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
