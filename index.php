    ...
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            <div class="post-preview">
                <a href="post.html">
                    <h2 class="post-title">
                        Mieux que Tinder, FRIIENDS est là pour vous
                    </h2>
                    <h3 class="post-subtitle">
                        Plus qu'une histoire d'amour ou un coup d'un soir, FRIIENDS crée des liens amicaux
                    </h3>
                </a>
            ...
            <div class="post-preview">
                <a href="post.html">
                    <h2 class="post-title">
                        J'ai moi-même trouvé une copine et des potes via FRIIENDS
                    </h2>
                </a>
                <p class="post-meta">Posté par
                    <a href="#">Maxime</a>
