        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Inscrits</h1>
                    <span class="subheading">Descends pour voir les inscrits!</span>
                </div>
            </div>
        </div>
    </div>
...
<div align="center">
    ...
    $i=0;
    while($i<=2){
        printf('<font size="6pt"><a href="profil.php?id=%s">%s %s</a></font><br />',$i,membres_id_prenom($i),membres_id_nom($i));
        $i=$i+1;
    }
    ?>
</div>
